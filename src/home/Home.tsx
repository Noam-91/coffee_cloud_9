...
const Home = (props:HomeProps)=>{
    const textImgContent= [
        {name: "Item 1",
        image: "https://static.wixstatic.com/media/cb3366_34a5ded414284baab5bb7757006ec276~mv2.jpg/v1/fit/w_2500,h_1330,al_c/cb3366_34a5ded414284baab5bb7757006ec276~mv2.jpg",
    ...
    const items = [
        {name:"Carousel 1",
        image:"https://cdn.shopify.com/s/files/1/0312/2897/articles/coffee_beans_800x.png?v=1648141678",
        ...
        ,
        {name:"Carousel 2",
        image:"https://i.pinimg.com/564x/cf/e7/c2/cfe7c2c36f97df5e6b149ca63f41918a.jpg",
        ...
        ,
        {name:"Carousel 3",
        image:"https://coffeeclick.ie/wp-content/uploads/2021/07/white-coffee-cup-roasted-coffee-beans-around-1024x683.jpeg",
